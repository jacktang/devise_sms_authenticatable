module DeviseSmsAuthenticatable
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      desc "Add DeviseSmsAuthenticatable config variables to the Devise initializer and copy DeviseSms locale files to your application."
      ...
      def add_config_options_to_initializer
        ...
        if File.exist?(devise_initializer_path)
          ...
          if old_content.match(Regexp.new(/^\s# ==> Configuration for :sms_authenticatable\n/))
            false
          else
            inject_into_file(devise_initializer_path, :before => "  # ==> Configuration for :confirmable\n") do
<<-CONTENT
  # ==> Configuration for :sms_authenticatable
...
CONTENT
      ...
      def copy_locale
        copy_file "../../../config/locales/en.yml", "config/locales/devise_sms_authenticatable.en.yml"
      end
